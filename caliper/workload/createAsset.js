    ...
    */
    ...
    async submitTransaction() {
        ...
        const fintechData = 
            [{
            ID: 'accountIdNine9',
            Username: 'random-username923',
            UserAccountIdentification: 'some-identificationaccountNine',
            AccountWalletBalance: 327,
            AccountCurrency: 'GBP',
            AccountLastTransaction: 20,
            AccountTotalTransaction: 3922,
            TotalTransaction: 103,
            AccountFirstName: 'Chioma',
            AccountLastName: 'Auba',
            AccountLocation: 'GB',
        }];


        console.log('about to log fintech data');
